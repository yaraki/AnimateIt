...
internal class CheeseBoardAdapter :
    ...
    val onScrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            recyclerView.forEachVisibleHolder { holder: CheeseBoardViewHolder ->
                holder.rotation
                    // Update the velocity.
    ...
    override fun onBindViewHolder(holder: CheeseBoardViewHolder, position: Int) {
...
internal class CheeseBoardViewHolder(
     ...
     *
     * The animation is started in [CheeseBoardAdapter.onScrollListener].
     */
