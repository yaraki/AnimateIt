...
import io.github.yaraki.animateit.databinding.PageResourcesBinding
import io.github.yaraki.animateit.deck.Page
import io.github.yaraki.animateit.deck.PageFragment

class ResourcesFragment : PageFragment() {

    companion object : Page {
        override fun create() = ResourcesFragment()
    }

    private lateinit var binding: PageResourcesBinding
